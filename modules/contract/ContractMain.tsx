...
import { FileBadge, Search, Download, FileUp, Paperclip, UserCircle, Upload, FileText, AlertCircle, Calendar, Trash2 } from 'lucide-react';
          ...
          <tbody className="divide-y divide-gray-50">
            {isLoading ? (
              ...
              filteredContracts.map(c => {
                ...
                return (
                  <tr key={c.id} className={`hover:bg-gray-50/50 transition-colors ${isSelected ? 'bg-emerald-50/20' : ''}`}>
